...
export async function generateAdmissionLetterPdf(
  ...
  const bodyParagraph1 = 
    `I am pleased to inform you that you have been offered provisional admission to Borabu Teachers Training College (BTTC) to pursue a course of study leading to a ${data.programmeName}.`;
  ...
  doc.text('BORABU BTTC REGISTRAR', 18, currentY + 16);
